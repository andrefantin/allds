    ...
    <div className="min-h-screen bg-ds-bg flex items-center justify-center">
      <div className="card p-8 w-full max-w-sm">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-[2rem] font-bold text-ds-text">Design Systems</h1>
          <p className="text-[1.2rem] text-ds-text-muted">Sign in to continue</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-[1.2rem] text-ds-text-muted mb-1">Email</label>
            <input
              type="text"
              value={email}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-ds-heading text-white font-semibold rounded-lg hover:bg-ds-heading/90 transition-colors text-[1.3rem] disabled:opacity-50"
          >
