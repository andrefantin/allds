...
export async function POST(req: Request, { params }: { params: { tenant: string } }) {
  ...
  const ALLOWED_KEYS = ['figmaToken', 'figmaFileComponents', 'figmaFileModules', 'figmaFileFoundation', 'figmaIconNodeId', 'figmaIconSetName', 'figmaIconNodeId2', 'figmaIconSetName2', 'figmaIconSets', 'figmaAdditionalLibraries', 'ogImageUrl', 'logoUrl']
